...
public class HexTest {
    ...
    private void testCustomCharset(final String name, final String parent) throws UnsupportedEncodingException,
        ...
        assertArrayEquals(expectedHexStringBytes, actualEncodedBytes, "Verificando se o array expectedHexStringBytes é igual ao array actualEncodedBytes");
        // test 2
        String actualStringFromBytes = new String(actualEncodedBytes, name);
        assertEquals(expectedHexString, actualStringFromBytes, "Verificando se expectedHexString é igual ao actualStringFromBytes");
        // second test:
        ...
        // sanity check:
        assertEquals(sourceString, actualStringFromBytes, "Verificando se sourceString é igual ao actualStringFromBytes");
        // actual check:
    ...
    public void testCustomCharsetToString() {
        assertTrue(new Hex().toString().indexOf(Hex.DEFAULT_CHARSET_NAME) >= 0, "verifica se a condição  Hex().toString().indexOf(Hex.DEFAULT_CHARSET_NAME) >= 0 é verdadeira");
    }
